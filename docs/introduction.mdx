...
Each trail usually starts near train station (sometimes tram stop) and it ends not far away from a train station.

For more detailed information about transportation please see [Transportation](transportation/overview) page.

## Disclaimer

GPX routes on this site are meant merely as a suggestion and author bears no responsibility for using it.
